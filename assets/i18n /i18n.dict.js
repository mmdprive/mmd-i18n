/* =====================================================
   MMD • I18N DICT (ALL-IN-ONE)
   - Safe merge only
   - Includes: Benefits Lite + Comparison + Black Card + Helpers + Pay + Renewal
   - Webflow/CDN safe (NO <script> tags)
===================================================== */
...
/* =======================
   ZH (Simplified)
   (Pay/Renewal omitted intentionally -> fallback to EN)
======================= */
